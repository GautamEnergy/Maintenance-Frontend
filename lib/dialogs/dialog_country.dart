...
// import '../Utility/role_list_model.dart';
import 'package:Maintenance/dialogs/role_list_model.dart';
import '../constant/app_color.dart';
import '../constant/app_fonts.dart';
import '../constant/app_styles.dart';

class DialogRoleAllCountry extends StatefulWidget {
  final CountryRoleModel? data;
  final String? ImagePath;
  const DialogRoleAllCountry({
    Key? key,
    this.data,
    this.ImagePath,
  }) : super(key: key);
  ...
  @override
  _DialogRoleCountry createState() => _DialogRoleCountry();
}

class _DialogRoleCountry extends State<DialogRoleAllCountry> {
  double padding = 10;
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      var Dialogdata = {
                        "iso": Countrylist[index].iso,
                        "Countryname": Countrylist[index].nicename
                      };
